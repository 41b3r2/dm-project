    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            <a href="" class="navbar-brand p-0">
                <h1 class="text-primary m-0"><i class="fa fa-map-marker-alt me-3"></i>Samar</h1>
...
// Check if 'Locationid' is passed in the URL
if (isset($_GET['Locationid'])) {
    $Locationid = $_GET['Locationid'];

    // Fetch package details based on Locationid
    $sql = "SELECT * FROM package WHERE Locationid = ?";  // Assuming Locationid is unique
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("i", $Locationid);  // "i" stands for integer
    $stmt->execute();
    ...
    if ($result->num_rows > 0) {
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5"><?php echo $row['LocationSpot']; ?></h1>
                </div>
                <div class="row g-4 justify-content-center">
                    <div class="col-lg-8">
                        <div class="package-item">
                            <div class="overflow-hidden">
                                <img class="img-fluid" src="img/<?php echo $row["Imagespot"]; ?>" alt="">
                            </div>
                            <div class="d-flex border-bottom">
                                <small class="flex-fill text-center border-end py-2">
                                    <i class="fa fa-map-marker-alt text-primary me-2"></i><?php echo $row["LocationSpot"]; ?>
                                </small>
                                <small class="flex-fill text-center border-end py-2">
                                    <i class="fa fa-calendar-alt text-primary me-2"></i><?php echo $row["Days"]; ?> days
                                </small>
                                <small class="flex-fill text-center py-2">
                                    <i class="fa fa-user text-primary me-2"></i><?php echo $row["Person"]; ?> Persons
                                </small>
                            </div>
                            <div class="text-center p-4">
                                ...
                                <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; padding: 20px;">
                                    <div style="text-align: center;">
                                        <p style="font-size: 18px; color: #333; font-weight: bold; margin-bottom: 10px;">ACTIVITY</p>
                                        <p style="margin: 0;"><?php echo $row["Activity"]; ?></p>
                                    </div>
                                    
                                    <div style="text-align: center;">
                                        <p style="font-size: 18px; color: #333; font-weight: bold; margin-bottom: 10px;">LOCATION</p>
                                        <p style="margin: 0;"><?php echo $row["Location"]; ?></p>
                                    </div>
                                    
                                    <div style="text-align: center;">
                                        <p style="font-size: 18px; color: #333; font-weight: bold; margin-bottom: 10px;">DESCRIPTION</p>
                                        <p style="margin: 0;"><?php echo $row["Description"]; ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        echo '<p class="text-center">No details found for this package.</p>';
    }

    $stmt->close();
} else {
    echo '<p class="text-center">No package selected.</p>';
}
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-md-6 text-white">
                        ...
                        <button 
                            ...
                            type="button" 
                            <?php echo $isLoggedIn ? 'enabled' : 'onclick="openModal()"'; ?>
                        >
                            Read More
                        </button>
                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        ...
                                        >
                                            ...
                                            <?php
                                            // Placeholder for fetching data dynamically
                                            // Replace $resultBook with actual database query result
                                            if (isset($resultBook) && $resultBook->num_rows > 0) {
                                                while ($row = $resultBook->fetch_assoc()) {
                                                    echo '<option value="' . $row['Locationid '] . '">' . $row['LocationSpot'] . '</option>';
                                                }
                                            } else {
                                                echo '<option value="">Walang package na available</option>';
                                            }
                                            ?>
                                        </select>
