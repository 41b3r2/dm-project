        ...
        <div class="row gx-0">
            <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    ...
                    <small class="me-3 text-light"><i class="fa fa-phone-alt me-2"></i>+012 345 6789</small> <!-- BACKEND -->
                    <small class="text-light"><i class="fa fa-envelope-open me-2"></i>its.samar.time@gmail.com</small> <!-- BACKEND -->
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <h5>Get In Touch</h5>
                    <p class="mb-4">Website details..</p>
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0">Location, Samar, Philippines</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-4">
                        <div class="d-flex align-items-center justify-content-center flex-shrink-0 bg-primary" style="width: 50px; height: 50px;">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0">its.samar.time@gmail.com</p>
                        </div>
                    </div>
                </div>
                 <!-- BACKEND MAP !! -->
                 <div class="col-lg-4 col-md-6">
                    <iframe class="position-relative rounded w-100 h-100"
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1004021.7797543392!2d124.5!3d11.5!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3307ea238b8b6585%3A0x888cefb3876d90d1!2sSamar!5e0!3m2!1sen!2sph!4v1637824991264!5m2!1sen!2sph"
