...
$sql = "SELECT AdminId, Fname, Mname, Lname, Email, Contact, Profilepic FROM admin";
              ...
              <?php
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<tr>";
                        echo "<td style='text-align: center; vertical-align: middle;'><div class='user'><img src='$image' alt='User Image'></div></td>";
                        echo "<td style='text-align: left; vertical-align: middle;'>$fullName</td>";
                        echo "<td style='text-align: center; vertical-align: middle;'>" . $row['Email'] . "</td>";
                        echo "<td>" . $row['Contact'] . "</td>";
                        echo "<td>
                                  <a href='admindetails.php?id=" . $row['AdminId'] . "' 
                                    style='
                                        display: inline-block; 
                                        padding: 5px 15px; 
                                        background-color: #2C6975; 
